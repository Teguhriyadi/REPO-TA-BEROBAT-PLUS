          ...
          <View style={{marginVertical: 10, marginHorizontal: 10}}>
            ...
            <View style={{flexDirection: 'row', marginVertical: 10}}>
              ...
              <View>
                ...
                <Text style={{color: 'black', fontSize: 12}}>Dokter Umum</Text>
              </View>
            </View>
          </View>
          <View style={{marginHorizontal: 10, marginBottom: 20, alignItems: 'flex-end'}}>
            <TouchableOpacity style={{borderColor: 'purple', borderWidth: 1, borderRadius: 10}}>
              <Text style={{color: 'purple', paddingHorizontal: 20, paddingVertical: 5, fontSize: 10}}>
                Chat Ulang
              </Text>
            </TouchableOpacity>
          </View>
